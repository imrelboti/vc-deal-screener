...
const MOROCCAN_STARTUPS = [
  ...
  },
  {
    ...
    employees: 55,
    foundedYear: 2010,
    description: 'Marque de snacks et confiseries distribuée via un réseau digitalisé.',
    founders: ['Jawad Ziyat'],
    website: 'https://koolfood.ma',
    contact: { email: 'contact@koolfood.ma', phone: '+212 5 22 XX XX XX', linkedin: 'kool-food' },
    metrics: { gmv: 88, customerAcquisition: 80, marginStructure: 85, logistics: 75, brandStrength: 92 },
    highlights: ['Leader local du snacking', 'Distribution omnicanale', 'Forte identité de marque']
  },
  {
    id: 42,
    name: 'Mobacash',
    ...
    employees: 12,
    foundedYear: 2021,
    description: 'Solution de Mobile Money et paiement de factures sans compte bancaire.',
    founders: ['Hamza Nabli'],
    website: 'https://mobacash.ma',
    contact: { email: 'info@mobacash.ma', phone: '+212 5 37 XX XX XX', linkedin: 'mobacash' },
    metrics: { regulatoryCompliance: 95, financialTraction: 70, securityInfra: 88, teamExperience: 75, marketSize: 90 },
    highlights: ['Inclusion financière rurale', 'Interface USSD et App', 'Partenariat télécoms']
  },
  {
    id: 43,
    name: 'Pipit Global MA',
    sector: 'fintech',
    stage: 'Seed',
    location: 'Casablanca',
    ...
    employees: 10,
    foundedYear: 2020,
    description: 'Plateforme de paiement transfrontalier pour le règlement de factures.',
    founders: ['Juliette Flynn'],
    website: 'https://pipit.global',
    contact: { email: 'maroc@pipit.global', phone: '+212 5 22 XX XX XX', linkedin: 'pipit-global' },
    metrics: { regulatoryCompliance: 88, financialTraction: 65, securityInfra: 92, teamExperience: 80, marketSize: 85 },
    highlights: ['Focus sur la diaspora', 'Réseau de points de cash', 'Transferts sécurisés']
  },
  {
    id: 44,
    name: 'SOWIT',
    ...
    employees: 22,
    foundedYear: 2018,
    description: 'Analyses de données par drones et satellites pour l\'agriculture de précision.',
    founders: ['Hamza Rkha Chaham', 'Fahd Benani'],
    website: 'https://sowit.com',
    contact: { email: 'contact@sowit.fr', phone: '+212 6 XX XX XX XX', linkedin: 'sowit' },
    metrics: { yieldImprovement: 92, farmerAdoption: 70, techReliability: 95, costEfficiency: 85, sustainabilityImpact: 90 },
    highlights: ['Présence dans 10+ pays d\'Afrique', 'Optimisation des engrais', 'Aide à la décision en temps réel']
  },
  {
    id: 45,
    name: 'Cathedis',
    ...
    employees: 100,
    foundedYear: 2020,
    description: 'Solution de livraison 100% digitale spécialisée dans le dernier kilomètre.',
    founders: ['Imane Belmaati'],
    website: 'https://cathedis.ma',
    contact: { email: 'hello@cathedis.ma', phone: '+212 5 22 XX XX XX', linkedin: 'cathedis' },
    metrics: { deliverySpeed: 95, networkCoverage: 88, costStructure: 80, customerSatisfaction: 90, techStack: 85 },
    highlights: ['Tracking temps réel', 'Traitement automatisé des retours', 'Forte croissance e-commerce B2C']
  },
  {
    id: 46,
    name: 'Gwala',
    ...
    employees: 8,
    foundedYear: 2022,
    description: 'Plateforme de versement de salaire à la demande pour les employés.',
    founders: ['Mounir Lahlou'],
    website: 'https://gwala.ma',
    contact: { email: 'contact@gwala.ma', phone: '+212 6 XX XX XX XX', linkedin: 'gwala-app' },
    metrics: { regulatoryCompliance: 80, financialTraction: 60, securityInfra: 85, teamExperience: 78, marketSize: 88 },
    highlights: ['Bien-être financier', 'Intégration RH simplifiée', 'Zéro dette pour l\'employé']
  },
  {
    id: 47,
    name: 'Jobop',
    ...
    employees: 15,
    foundedYear: 2021,
    description: 'Marketplace de travail intérimaire et gestion du personnel on-demand.',
    founders: ['Salim Memon'],
    website: 'https://jobop.co',
    contact: { email: 'contact@jobop.co', phone: '+212 5 22 XX XX XX', linkedin: 'jobop-maroc' },
    metrics: { arr: 75, growthRate: 90, churnRate: 85, ltv_cac: 80, productMarketFit: 82 },
    highlights: ['Algorithme de matching rapide', 'Focus secteurs BTP/Logistique', 'Digitalisation de l\'intérim']
  },
  {
    id: 48,
    name: 'Lamma',
    ...
    employees: 25,
    foundedYear: 2021,
    description: 'Application de Quick-commerce pour la livraison de courses en 30 min.',
    founders: ['Hamza Guedira'],
    website: 'https://lamma.ma',
    contact: { email: 'hello@lamma.ma', phone: '+212 5 22 XX XX XX', linkedin: 'lamma-app' },
    metrics: { deliverySpeed: 98, networkCoverage: 70, costStructure: 65, customerSatisfaction: 85, techStack: 88 },
    highlights: ['Dark stores urbains', 'UX ultra-rapide', 'Livraison de nuit']
  },
  {
    id: 49,
    name: 'Smart Prof',
    ...
    employees: 10,
    foundedYear: 2021,
    description: 'Plateforme de mise en relation pour le soutien scolaire personnalisé.',
    founders: ['Mustapha El Fayz'],
    website: 'https://smartprof.ma',
    contact: { email: 'contact@smartprof.ma', phone: '+212 6 XX XX XX XX', linkedin: 'smartprof' },
    metrics: { learningOutcomes: 88, userEngagement: 92, contentQuality: 85, scalability: 80, monetization: 75 },
    highlights: ['Tuteurs certifiés', 'Suivi pédagogique digital', 'Croissance organique forte']
  },
  {
    id: 50,
    name: 'WeCasahost',
    ...
    employees: 14,
    foundedYear: 2019,
    description: 'Gestion complète de conciergerie Airbnb et locations saisonnières.',
    founders: ['Mehdi Bennis'],
    website: 'https://wecasahost.com',
    contact: { email: 'contact@wecasahost.com', phone: '+212 5 22 XX XX XX', linkedin: 'wecasahost' },
    metrics: { transactionVolume: 85, platformEfficiency: 82, userTrust: 90, marketCoverage: 75, regulatoryCompliance: 80 },
    highlights: ['Optimisation du Yield', 'Maintenance intégrée', 'Service premium']
  }
];
